...
// We generate the 15 sensors as a plain string. No loops in the React code.
...
fs.writeFileSync('src/components/schematics/HomeAnatomy.tsx', content);
console.log("✅ COMPONENT OVERWRITTEN. NO LOOPS. NO BUGS.");
